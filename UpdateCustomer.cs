...
namespace WendyMonahanC969
{
    ...
    {
        int passID;
        public UpdateCustomer(int customerPassID)
        {
            InitializeComponent();
            passID = customerPassID;
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DBConnection.alterCustomer(passID, nameTextBox.Text, addressTextBox.Text, address2TextBox.Text, cityTextBox.Text, countryTextBox.Text, postalCodeTextBox.Text, phoneTextBox.Text, activeCheck);
                    Close();
                }
            }       
        }
