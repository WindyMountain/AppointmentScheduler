...
namespace WendyMonahanC969
{
    ...
    {
        string localTimeZoneAA;
        public AddAppointment(string localTimeZoneMS)
        {
            InitializeComponent();
            localTimeZoneAA = localTimeZoneMS;
            startTimeZone.Text = localTimeZoneAA;
            endTimeZone.Text = localTimeZoneAA;
        }
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DBConnection.insertAppointment(currentAppointment);
                    Close();
                    }
                }
            }
